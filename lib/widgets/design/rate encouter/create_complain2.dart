...
class CreateComplain2 extends StatelessWidget {
  const CreateComplain2({Key? key}) : super(key: key);
            ...
            Padding(
              ...
              child: ListView(
                ...
                children: [
                  ...
                  Wrap(
                    children: [
                      textChip(action: Icon(
                              Icons.remove_circle_outline,
                            color: Colors.black,
                          ), radius: 10, bgcolor: Color(0xffEDF2F7), text: "Headache",textColor:Colors.black,),
                      textChip(action: Icon(
                              Icons.remove_circle_outline,
                            color: Colors.black,
                          ), radius: 10, bgcolor: Color(0xffEDF2F7), text: "Stolling",textColor:Colors.black,),
                      textChip(action: Icon(
                              Icons.remove_circle_outline,
                            color: Colors.black,
                          ), radius: 10, bgcolor: Color(0xffEDF2F7), text: "Discharge from anything",textColor:Colors.black,),
