...
class _EmailUsScreenState extends State<EmailUsScreen> {
          ...
          child: Column(
            children: [
              ...
              AVInputField(
                ...
                validator: (String? v) => ValidationService.isValidInput(v!, minLength: 4),
              ),
              SizedBox(height: 5,),
              AVInputField(
                label: "Name",
  ...
  void submit()async {
    ...
    http.Response response = await HttpServices.post(context, 'communication/contactus/email', payload);
    // print(response.body);
